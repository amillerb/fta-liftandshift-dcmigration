...
# VNet Creation - Create an RG and Isolated VNet

# New-AzResourceGroup -Name $RG -Location $Location
$defaultSubnet = New-AzVirtualNetworkSubnetConfig -Name $SubnetName -AddressPrefix $SubnetCIDR
New-AzVirtualNetwork -Name $VNetName -ResourceGroupName $RG -Location $Location -AddressPrefix $VNetCIDR -Subnet $defaultSubnet
